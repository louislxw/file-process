...
f1 = open("summary/summary_2019_07_09_15_51_56_cam1_PRC2.txt", 'r')  # Replace with a new PRC2 file
f2 = open("summary/summary_2019_07_09_15_51_56_cam1_RAW.txt", 'r')  # Replace with a new RAW file
f3 = open("data/coco.names", 'r')
f4 = open("summary/summary_2019_07_09_15_51_56_cam1.txt", 'wt')  # Replace with a new file
